...
const PROCESSOR_COLOR_BY_BUILDING_ID = {
    [PROCESSOR_BUILDING_IDS.EXTRACTOR]: 'rgba(220, 180, 40, 0.75)',
    [PROCESSOR_BUILDING_IDS.BIOREACTOR]: 'rgba(136, 230, 117, 0.75)',
    [PROCESSOR_BUILDING_IDS.REFINERY]: 'rgba(87, 213, 255, 0.75)',
    [PROCESSOR_BUILDING_IDS.FACTORY]: 'rgba(40, 120, 255, 0.75)',
    [PROCESSOR_BUILDING_IDS.SHIPYARD]: 'rgba(129, 129, 255, 0.75)',
    [PROCESSOR_BUILDING_IDS.EMPTY_LOT]: 'rgba(241, 131, 97, 0.75)',
};
